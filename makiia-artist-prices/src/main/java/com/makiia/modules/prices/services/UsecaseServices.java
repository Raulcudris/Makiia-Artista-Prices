...
import com.makiia.modules.prices.contracts.IjpaDataProviders;
...
public class UsecaseServices <T, K> {
     ...
     * @throws MicroEventException excepcion
     */
    public EntyRecmaetarivalorResponse getAll(int currentPage , int PageSize , String parameter,String filter) throws EBusinessException, MicroEventException {
        String transactionalId = UUID.randomUUID().toString();
